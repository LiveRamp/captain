...
public interface RequestUpdater {
  void setStatus(long jobId, CaptainStep currentStep, CaptainStatus currentStatus, CaptainStatus newStatus);

  void setStepAndStatus(long jobId, CaptainStep currentStep, CaptainStatus currentStatus, CaptainStep newStep, CaptainStatus newStatus);
